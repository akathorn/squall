...
public class UJMPVisualizer implements VisualizerInterface{
	// thickness of the rectangle line proportional to the overall dimension size
	...
	private void drawLine(Matrix m, int x1, int y1, int x2, int y2, 
			int xSize, int ySize, int colorRegion){
		if(x1 == x2){
			// horizontal line
			int aroundHor = (int) xSize / REGION_POINT_FACTOR;
			...
			// vertical line
			int aroundVer = (int) ySize / REGION_POINT_FACTOR;
